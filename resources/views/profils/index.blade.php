...
<div class="darksection">
    <div class="container" style="min-height: calc(100vh - 287px);">
        ...
        <div class="list-group mt-10">
             <!-- Je fais une boucle sur tous les profils pour tous les afficher. Si l'utilisateur est authentifié il voit tous les status, sinon il ne voit que les actifs-->
            @foreach($profiles as $profile)
                @if(auth()->check() || $profile->status == 'active') 
                    <div class="sm:flex bg-[#e5c78f] rounded-xl p-4 items-center justify-between my-8">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                @auth
                                    <div>
                                        <div class="text-[#168ebd] font-semibold underline">
